...
const RegisterPage = () => {
    return (
        ...
        <form className={styles.form}>
            <div className={styles.form__group}><label className={styles.form__label} for="username">Username</label><input
            ...
            <div className={styles.form__group + ' ' + styles["ma-bt-md"]}><label className={styles.form__label} for="rePassword">Repeat Password</label><input
